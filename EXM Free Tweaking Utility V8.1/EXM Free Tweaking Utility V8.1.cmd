...
@echo off
::Exm free tweaking utility v8.1 | Made and distributed by EXM TWEAKS, S.R.O. ® 2025
...
echo.
echo. 
echo.                                                                                   %W% EXM FREE TWEAKING UTILITY VERSION 8.1                        
echo.
echo.                                                                       %p% ██╗       ██╗███████╗██╗      █████╗  █████╗ ███╗   ███╗███████╗ 
echo.                                                                       %p% ██║  ██╗  ██║██╔════╝██║     ██╔══██╗██╔══██╗████╗ ████║██╔════╝ 
echo.                                                                       %p% ╚██╗████╗██╔╝█████╗  ██║     ██║  ╚═╝██║  ██║██╔████╔██║█████╗   
...
echo.  
echo.                                                                Made and distributed by EXM TWEAKS, S.R.O. ® 2024 * Version 8.1 * Updated 7th of February 2025
echo.                             %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%b%
echo.                               
echo.
echo.
...
echo.                                                                                                                                                                                 
echo.                                                  %p%[%w%10%p%]%w% Fix Corrupted Files                 %p%[%w%11%p%]%w% Uninstall Useless Apps                %p%[%w%12%p%]%w% EXM Network Tweaking Utility           
echo.                                                                                                                                                                                 
echo.                                        %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                                                                                                                                                 
...
echo.                                                                                                                                                                                   
echo.                                                                                                                                                                                  
echo.                                                         %p%%p%%p%%w%  Made and distributed by EXM TWEAKS, S.R.O. ® 2024 * Version 8.1 * Updated 7th of February 2025                   
echo.                                                                                                                                                                                 
echo.                                        %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
